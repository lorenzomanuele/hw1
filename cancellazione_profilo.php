    ...
    if (!empty($_POST["password"]) ){
        ...
        if ($res && mysqli_num_rows($res) > 0) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                $querySongs = "DELETE FROM canzoni WHERE user_id = '$userid'";
                if(!mysqli_query($conn, $querySongs)) {
                    $error = "Errore cancellazione delle canzoni dell'utente";
                }
                $queryEvents = "DELETE FROM eventi WHERE user_id = '$userid'";
                if(!mysqli_query($conn, $queryEvents)) {
                    $error = "Errore cancellazione degli eventi dell'utente";
                }
                if (mysqli_query($conn, $query)) {
                    header('Location: logout.php');
                } else {
                    $error = "Errore cancellazione del profilo";
                }
            } else {
...
<head>
    ...
    <link rel="stylesheet" href="cancellazione_profilo.css">
    <script defer src="cancellazione_profilo.js"></script>
</head>
...
<body>
    ...
    <section>
        <strong class="avviso">Ricorda che la cancellazione del profilo è definitiva e una
            volta confermata non sarà più possibile tornare indietro</strong>
        <div id="container_form">
            <form id="accesso" method="post">
                <div class="credenziale">
                    <label for='password' class="password1">Inserisci la password</label>
                    <input type='password' name='password' <?php if(isset($_POST["password"])){echo "value=".$_POST["password"];} ?>>
                </div>
                <input class="bottone_cancella_profilo" type='submit' value="ELIMINA PROFILO">
                <?php
                    if (isset($error)){
    ...
    <footer>
        ...
        <div class="flex-container5">
            ...
            <div class="item-paragraph" data-info="group2">
                ...
                <a class="azzurro">Persone con disabilità</a>
            </div>
            ...
            <div class="item-paragraph" data-info="group4">
                ...
                <a class="azzurro">Gift Voucher</a>
            ...
            <div class="item-paragraph" data-info="group5">
                ...
                <a class="azzurro">Diventa Punto Vendita</em></a>
