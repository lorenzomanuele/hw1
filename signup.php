<?php
        ...
        !empty($_POST["cognome"]) && !empty($_POST["confirm_password"]))
    {
        ...
        if (count($error) == 0) {
            ...
            $query = "INSERT INTO users(email, username, nome, cognome, password) VALUES('$email', '$username', '$nome', '$cognome', '$password')";
            ...
            <div id="container-secondario">
                    <form id="accesso" method="post">
                        <div class="credenziale">
                            ...
                            <input id="nome_id" type='text' name='nome' <?php if(isset($_POST["nome"])){echo "value=".$_POST["nome"];} ?>>
                        </div>
                        <div class="credenziale">
                            <label for='cognome'>Cognome</label>
                            <input id="cognome_id" type='text' name='cognome' <?php if(isset($_POST["cognome"])){echo "value=".$_POST["cognome"];} ?>>
                        </div>
                        <div class="credenziale">
                            <label for='email' >E-mail</label>
                            <input id="email_id" type='text' name='email' <?php if(isset($_POST["email"])){echo "value=".$_POST["email"];} ?>>
                        </div>
                        <div class="credenziale">
                            <label for='username'>Username</label>
                            <input id="username_id" type='text' name='username' <?php if(isset($_POST["username"])){echo "value=".$_POST["username"];} ?>>
                        </div>
                        <div class="credenziale">
                            <label for='password'>Password</label>
                            <input id="password_id" type='password' name='password' <?php if(isset($_POST["password"])){echo "value=".$_POST["password"];} ?>>
                        </div>
                        <div class="credenziale">
                            <label for='confirm_password' id="confirm_psw">Conferma Password</label>
                            <input id="cnfrm_password_id" type='password' name='confirm_password' <?php if(isset($_POST["confirm_password"])){echo "value=".$_POST["confirm_password"];} ?>>
                        </div>
                        <div>
                            <input class="bottone_accedi" type='submit' value="REGISTRATI">
                        </div>
                        <?php
                            if(isset($error)) {
                ...
                <div id="container-destra">
                    <span class="scritta_fianco">Per iscriverti assicurati di riempire tutti i campi
                        e che la password sia di almeno 8 caratteri. La password deve inoltre contenere
                        almeno una lettera maiuscola, un numero e un carattere speciale.
                    </span>
                </div>
            </div>
            <span>Oppure <a class="link_iscriviti" href="login.php">Accedi</a></span>
        </div>
    </section>
