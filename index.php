...
<head>
    ...
    <script defer src="hw1.js"></script>
</head>
...
<body>
    <header>
        ...
        <div class="flex-container2">
            ...
            <span class="white">ACCEDI QUI</span>
        </div>
        
        <div id="flex-container3">
            <!-- TENDINA DI ACCESSO O ISCRIZIONE -->
            <div id="scomparsa3" class="hidden">
                <div id="medium-container">
                    <div id="tendinadiaccesso">
                            <div class="accedi">
                                <a class="free" href="login.php">Accedi</a>
                            </div>
                            <span class="title">- oppure -</span>
                            <div class="accedi">
                                <a class="free" href="signup.php">Iscriviti</a>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div id="accedi_prima" class="hidden">
                <span>Prima devi fare l'accesso!</span>
            </div>
    ...
    <section>
        <div id="flex-container4">
            ...
            <span>Per salvare le tue canzoni preferite <a class="azzurro" href="login.php">accedi</a></span>
        </div>    
    ...
    <footer>
        ...
        <div class="flex-container5">
            ...
            <div class="item-paragraph" data-info="group3">
                ...
                <a class="azzurro">Polizza <em>Biglietto
                        Sicuro</em></a>
